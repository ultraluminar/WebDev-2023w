...
document.addEventListener('DOMContentLoaded',  async () => {
    ...
    class ComboBox {
        constructor(htmlElements, allOptionsTexts) {
            ...
            this.html.combobox1.button.addEventListener('mousedown', this.onButtonMouseDown.bind(this));
            this.html.combobox1.input.addEventListener('keydown', this.onInputKeyDown.bind(this));
            this.html.combobox1.input.addEventListener('mousedown', this.onInputMouseDown.bind(this));
            this.html.combobox1.input.addEventListener('input', this.filterOptions.bind(this));
            this.html.combobox1.input.addEventListener('blur', this.Close.bind(this));

            // TODO: ComboBox
            this.filterOptions();
        }
        dropdownOpen() {
            return this.html.combobox1.listbox.classList.contains('open');
        }
        ...
        filterOptions() {
            // TODO: filterOptions
            const filterText = this.html.combobox1.input.value;
            this.html.combobox1.listbox.innerHTML = '';

            this.options.all.forEach(option => {
